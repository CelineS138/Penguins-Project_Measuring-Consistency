...
long_forwards |> 
  ...
  geom_vline(aes(xintercept = med_mean_zscore), linetype = "dashed", size = 1) +
  geom_hline(aes(yintercept = med_zscore_wmc), linetype = "dashed", size = 1) +
...
long_forwards |> 
  ...
  geom_point(alpha = 0.5) +
  geom_vline(aes(xintercept = med_EVG_zscore), linetype = "dashed", size = 1) +
  geom_hline(aes(yintercept = med_EVG_wmc), linetype = "dashed", size = 1) +
...
long_forwards |> 
  ...
  geom_point(alpha = 0.5) +
  geom_vline(aes(xintercept = med_EVA_zscore), linetype = "dashed", size = 1) +
  geom_hline(aes(yintercept = med_EVA_wmc), linetype = "dasehd", size = 1) +
  geom_label_repel(size = 2, box.padding = 0.35) +
  labs(
...
long_forwards |> 
  ...
  geom_point(alpha = 0.5) +
  geom_vline(aes(xintercept = `med_S%_zscore`), linetype = "dashed", size = 1) +
  geom_hline(aes(yintercept = `med_S%_wmc`), linetype = "dashed", size = 1) +
  geom_label_repel(size = 2, box.padding = 0.25) +
  theme_light() +
  labs(
